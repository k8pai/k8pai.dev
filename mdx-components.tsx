...
const components = {
    h1: (props: HeadingProps) => (
        <h1 className="text-zinc-200 font-medium pt-12 mb-0" {...props} />
    ),
    ...
    h4: (props: HeadingProps) => (
        <h4 className="text-zinc-300 font-medium" {...props} />
    ),
    ...
    blockquote: (props: BlockquoteProps) => (
        <blockquote
            className="ml-[0.075em] border-l-3 border-gray-300 pl-4 text-gray-800 dark:border-zinc-300 dark:text-zinc-300"
            {...props}
        />
    ),
}
...
export function useMDXComponents(
    additionalComponents?: MDXProvidedComponents
): MDXProvidedComponents {
    return { ...additionalComponents, ...components }
}
