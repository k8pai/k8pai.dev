...
function about(){
  return (
	<div className='flex-grow flex sm:flex-col xsm:flex-col sm:items-center xsm:items-center justify-center'>
		<div className='mediv flex-col w-full max-w-[300px] dark:bg-secbg bg-tertxt h-fit m-3 rounded-3xl shadow-2xl'>
		...
		<div className='flex-grow space-y-5 dark:bg-secbg bg-tertxt h-fit m-3 rounded-3xl sm:rounded-xl xsm:rounded-md shadow-xl p-8 sm:p-5 xsm:p-3 sm:py-5 xsm:py-3'>
