	...
	<div className='flex-grow flex sm:flex-col xsm:flex-col sm:items-center xsm:items-center justify-center'>
		...
		<div className='flex-grow dark:bg-secbg bg-tertxt h-fit m-3 rounded-3xl sm:rounded-xl xsm:rounded-md shadow-xl'>
			<div className='aboutdiv p-8 sm:p-5 xsm:p-3 pb-0'>
				...
				<div className='my-2 mb-5 rounded-full w-[80px] h-[5px] bg-terbg shadow-xl'></div>
			...
			<div className='aboutdiv p-8 sm:p-5 xsm:p-3 pb-0'>
				<h1 className="font-semibold text-4xl tracking-wider font-mono capitalize md:text-center sm:text-center xsm:text-center">Education</h1>
				<div className='my-2 mb-5 rounded w-[80px] h-[3px] bg-terbg shadow-xl'></div>
				<Education />
					...
					<div class="timeline">
						<div class="timeline-item">
							<div class="timeline-item-content">
								<p class="text-sm font-medium text-gray-500">2020-2024</p>
								<p class="text-lg font-medium">Bachelor of Computer Science</p>
								<p class="text-sm">University of XYZ</p>
							</div>
						</div>
						<div class="timeline-item">
							<div class="timeline-item-content">
								<p class="text-sm font-medium text-gray-500">2016-2020</p>
								<p class="text-lg font-medium">Diploma in Computer Science</p>
								<p class="text-sm">College XYZ</p>
							</div>
						</div>
					</div>
				</div>
			...
			{/* <SkillsBar link={'https://www.typescriptlang.org/'} skill={"TypeScript"} lvl={60} component={SiTypescript} />
			<SkillsBar link={'https://web3js.readthedocs.io/en/v1.8.1/getting-started.html'} skill={"Web3"} lvl={62} component={SiWeb3Dotjs} />
			<SkillsBar link={'https://nextjs.org/'} skill={"Next Js"} lvl={78} component={SiNextdotjs} />
			<SkillsBar link={'https://nodejs.org/'} skill={"Node Js"} lvl={81} component={SiNodedotjs} />
			<SkillsBar link={'https://reactjs.org/'} skill={"React Js"} lvl={85} component={SiReact} />
			<SkillsBar link={'https://dev.java/learn/'} skill={"Java"} lvl={88} component={SiJava} />
			<SkillsBar link={'https://github.com/'} skill={"Git & Github"} lvl={90} component={SiGit} />
			<SkillsBar link={'https://developer.mozilla.org/en-US/docs/Learn/JavaScript'} skill={"JavaScript"} lvl={92} component={SiJavascript} />
			<SkillsBar link={'https://developer.mozilla.org/en-US/docs/Learn/CSS'} skill={"CSS3"} lvl={94} component={SiCss3} />
			<SkillsBar link={'https://developer.mozilla.org/en-US/docs/Learn/HTML'} skill={"HTML5"} lvl={95} component={SiHtml5} /> */}



			{/* <div className='whatIDo p-8'>
				<h1 className="font-semibold text-4xl tracking-wider font-mono capitalize md:text-center sm:text-center xsm:text-center">Projects</h1>
				<br />
				<div className='grid grid-cols-2 md:grid-cols-1 sm:grid-cols-1 xsm:grid-cols-1 gap-4 place-items-center'>
					<div className='dark:bg-terbg bg-sectxt h-fit w-full flex-grow flex rounded-lg shadow-sm'>
						<div className='picture p-3'>MetroBy Vehicles</div>
						<div className='skills p-3'>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</div>
					</div>
					<div className='dark:bg-terbg bg-sectxt h-fit w-full flex-grow flex rounded-lg shadow-sm'>
