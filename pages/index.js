...
import { BootstrapIcon, ExpressIcon, GithubIcon, GitIcon, HtmlIcon, JavaScriptIcon, MongodbIcon, MysqlIcon, NextJsIcon, NodeJsIcon, PrismaIcon, ReactIcon, ScssIcon, SolidityIcon, TailwindcssIcon, TypeScriptIcon, VercelIcon, VscodeIcon, Web3Icon } from '../components/socialIcons/SocialIcons';
		...
		<div className="flex-grow flex flex-col bg-tertext">
			...
			<div className='w-full '>
				...
				<div className='flex flex-wrap justify-center'>
					<div className='px-6 py-2 mx-4 my-2 bg-gray-50 dark:bg-terbg mt-6 rounded-lg flex items-center transition duration-200 hover:scale-125 cursor-pointer'>
						<NextJsIcon />
					...
					<div className='px-6 py-2 mx-4 my-2 bg-gray-50 dark:bg-terbg mt-6 rounded-lg flex items-center transition duration-200 hover:scale-125 cursor-pointer'>
						<TailwindcssIcon />
						<p className='ml-4 text-lg font-semibold'>Tailwind CSS</p>
					</div>
					<div className='px-6 py-2 mx-4 my-2 bg-gray-50 dark:bg-terbg mt-6 rounded-lg flex items-center transition duration-200 hover:scale-125 cursor-pointer'>
						<NodeJsIcon />
					...
					<div className='px-6 py-2 mx-4 my-2 bg-gray-50 dark:bg-terbg mt-6 rounded-lg flex items-center transition duration-200 hover:scale-125 cursor-pointer'>
						<ExpressIcon />
						<p className='ml-4 text-lg font-semibold'>Express JS</p>
					</div>
					<div className='px-6 py-2 mx-4 my-2 bg-gray-50 dark:bg-terbg mt-6 rounded-lg flex items-center transition duration-200 hover:scale-125 cursor-pointer'>
						<ScssIcon />
