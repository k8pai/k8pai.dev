...
export default function TeachAndTools(props) {
	const { techs } = props;
	return (
		<div className='max-w-7xl w-full mx-auto min-h-screen h-full flex flex-col justify-center'>
			<div className="mx-4">
			...
			<br />
			<div className='flex flex-wrap justify-between xsm:justify-center text-black'>
				{techs.map((data, ind) => 
					<div key={ind} className='px-6 py-3 mx-4 my-2 w-48 bg-gray-50 mt-6 rounded-lg flex items-center transition duration-200 hover:scale-125 cursor-pointer'>
						<data.component />
