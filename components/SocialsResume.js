...
export default function SocialsResume() {
	return (
		<div className='nameProfSocials flex-col items-center w-full mx-auto space-y-4 my-3'>
			...
			<h1 className="font-semibold text-base dark:bg-neutral-700 p-px px-3 rounded-full bg-tertxt font-mono capitalize w-fit mx-auto text-center">fullstack developer</h1>
